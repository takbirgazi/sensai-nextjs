...
const TopSection = () => {
    return (
        <section className="banner-section relative py-16 mx-5 z-10">
                                ...
                                <form method="post" action="index.html">
                                    <div className="form-group flex flex-col md:flex-row relative items-center gap-5">
                                        <input
                                            ...
                                            required
                                            className="w-full border border-gray-300 focus:border-orange-500 focus:outline-orange-500  rounded-full text-sm md:text-base text-gray-400 bg-white px-6 py-5 shadow-lg transition-all duration-500 ease-in-out"
                                        />
                            ...
                            <div className="flex flex-col md:flex-row flex-wrap">
                                <div className="w-full md:w-1/2 p-2">
                                    <figure className="image">
                                        <img src="assets/images/banner/banner-img-1.jpg" alt="Banner 1" className="w-full h-auto rounded shadow-lg" />
                                    </figure>
                                </div>
                                <div className="w-full md:w-1/2 p-2">
                                    <figure className="image">
                                        <img src="assets/images/banner/banner-img-2.jpg" alt="Banner 2" className="w-full h-auto rounded shadow-lg" />
                                    </figure>
                                </div>
                                <div className="w-full md:w-1/2 p-2">
                                    <figure className="image">
                                        <img src="assets/images/banner/banner-img-3.jpg" alt="Banner 3" className="w-full h-auto rounded shadow-lg" />
                                    </figure>
                                </div>
                                <div className="w-full md:w-1/2 p-2">
                                    <figure className="image">
                                        <img src="assets/images/banner/banner-img-4.jpg" alt="Banner 4" className="w-full h-auto rounded shadow-lg" />
                                    </figure>
                                </div>
                            </div>
                        </div>
